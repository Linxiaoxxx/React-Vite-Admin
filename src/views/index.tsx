...
export default function Home() {
  ...
  const { data: lineData = [], send: getLineData } = useWatcher(request.Get('/line/data', { params: { day } }), [day])
  const [rank, setRank] = useState(5)
  const { data: barData = [], send: getBarData } = useWatcher(request.Get('/bar/data', { params: { rank } }), [rank])
  ...
  return (
    ...
    <div className="grid grid-cols-3 wh-full gap-16 overflow-auto p-16">
      ...
      <Card
        ...
        onTabChange={(v: string) => setActiveTabKey(v)}
      >
        content-
        {activeTabKey}
      </Card>
